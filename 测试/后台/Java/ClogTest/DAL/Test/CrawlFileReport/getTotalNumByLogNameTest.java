...
public class getTotalNumByLogNameTest
{
	...
	private List<Model.GetByLogName.DALData> data = null;
	...
	@Test
	public void testReturnLogNameList() throws Exception{
		assertEquals("a", this.data.get(0).logName);
		assertEquals("a", this.data.get(3).logName);
		assertEquals("b", this.data.get(4).logName);
		assertEquals("b", this.data.get(5).logName);
	}
	@Test
	public void testReturnReportTimeList() throws Exception{
		assertEquals(1372050300, this.data.get(0).reportTime);
		assertEquals(1372051200, this.data.get(3).reportTime);
		assertEquals(1372050600, this.data.get(4).reportTime);
		assertEquals(1372050900, this.data.get(5).reportTime);
	}
	@Test
	public void testReturnCorrectTotalNumList() throws Exception{
		assertEquals(3, this.data.get(0).correctTotalNum);
		assertEquals(7, this.data.get(1).correctTotalNum);
		assertEquals(4, this.data.get(2).correctTotalNum);
		assertEquals(3, this.data.get(3).correctTotalNum);
		assertEquals(2, this.data.get(4).correctTotalNum);
		assertEquals(1, this.data.get(5).correctTotalNum);
	}
	@Test
	public void testReturnWrongTotalNumList() throws Exception{
		assertEquals(4, this.data.get(0).wrongTotalNum);
		assertEquals(6, this.data.get(1).wrongTotalNum);
		assertEquals(1, this.data.get(2).wrongTotalNum);
		assertEquals(1, this.data.get(3).wrongTotalNum);
		assertEquals(2, this.data.get(4).wrongTotalNum);
		assertEquals(1, this.data.get(5).wrongTotalNum);
	}
}
