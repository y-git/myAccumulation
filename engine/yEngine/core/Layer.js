...
(function () {
    ...
    namespace("YE").Layer = YYC.AClass(YE.NodeContainer, {
        ...
        Protected: {
            ye_P_run: function () {
                this.iterator("onbeforeRun");

                this.iterator("update");

                if (this.ye___isChange()) {
                    this.clear();
                    this.iterator("onbeforeDraw", this.getContext());
                    this.draw(this.getContext());
                    this.iterator("onafterDraw", this.getContext());
                    this.setStateNormal();
                }

                this.iterator("onafterRun");
                this.change();
            }
        },
        Public: {
...
//
            ...
            startLoop: function () {
                this.onstartLoop();
                this.iterator("onstartLoop");
            },
            endLoop: function () {
                this.iterator("onendLoop");
                this.onendLoop();
            },
            Virtual: {
                clear: function () {
                ...
                draw: function (context) {
                    this.iterator("draw", context || this.getContext());
                }
            },

            //*供测试使用

            forTest_getCanvas: function () {
                return this.ye___canvas;
            },
            forTest_setCanvas: function (canvas) {
                this.ye___canvas = canvas;
            },
            forTest_setContext: function (context) {
