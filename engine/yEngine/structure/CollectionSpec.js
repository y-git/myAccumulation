    ...
    describe("iterator", function () {
        describe("如果第1个参数为function", function () {
            it("遍历集合内元素，调用并将元素传给参数function", function () {
                ...
                collection.iterator(function (ele, num) {
                    a += ele;
                    a += num;
                }, 5);
