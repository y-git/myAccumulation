...
<script runat="server">
	...
	{	
        ...
        //var name12="txx";
        BaseUrl = "/ckfinder/userfiles/" + Convert.ToString(Session["userName"]);
        ...
        //上传个数上限：10个
        //上传大小上限：2M
        /* 个数和大小上限 改在AllowedExtensions中配置（第一个元素）*/
		type.AllowedExtensions = new string[] { "10|2000000", "aiff", "asf", "avi", "csv", "doc", "docx", "fla", "gz", "gzip", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
		type.DeniedExtensions = new string[] { };
        

		type = ResourceType.Add( "图片" );
		type.Url = BaseUrl + "images/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "images/";
        //type.MaxSize = 1000000;     //1M
		type.AllowedExtensions = new string[] {"20|1000000", "bmp", "gif", "jpeg", "jpg", "png" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Flash" );
		type.Url = BaseUrl + "flash/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "flash/";
        //type.MaxSize = 2000000;     //2M
		type.AllowedExtensions = new string[] {"10|2000000", "swf", "flv" };
		type.DeniedExtensions = new string[] { };
	}
