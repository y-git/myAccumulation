...
(function () {
    ...
    function Chart(userOptions, callback) {
        ...
        if (userOptions.optimization !== false) {
            options.plotOptions.spline.animation = false;   //禁止动画
            options.plotOptions.spline.marker.enabled = false;  //不显示点
            options.plotOptions.spline.marker.states.hover.enabled = true;
        }
    ...
    Chart.prototype = {
        ...
        render: function () {
            ...
            each(chart.series, function (serie) {
                ...
                serie.render(chart.optimization);  //jackycyang
            });
